function j_matrix = get_linearization()
    ...
    x_eq = [1 1 0 0 0 0];
    tau_eq = [0 0];
    A = double(subs(A, [X(1);X(2);X(3);X(4);X(5);X(6);Tau(1);Tau(2)], [x_eq'; tau_eq']));
    B = double(subs(B, [X(1);X(2);X(3);X(4);X(5);X(6);Tau(1);Tau(2)], [x_eq'; tau_eq']));
    C = double(subs(C, [X(1);X(2);X(3);X(4);X(5);X(6);Tau(1);Tau(2)], [x_eq'; tau_eq']));
    D = double(subs(D, [X(1);X(2);X(3);X(4);X(5);X(6);Tau(1);Tau(2)], [x_eq'; tau_eq']));
