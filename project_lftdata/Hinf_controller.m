...
%% Controllore Hinf con HINFSYN

nmeas=4;    % Numero uscite dall'impianto
nu=2;   % Numero ingressi all'impianto
[Khinf,CL,gamma] = hinfsyn(P_i,nmeas,nu);   % Controllore ottimo Hinfinito
[Ahinf,Bhinf,Chinf,Dhinf] = ssdata(Khinf);
looptrans = loopsens(Gp,Khinf); % Funzione di trasferimento a ciclo chiuso
...
legend('KS','gopt/WU'); hold off;
% figure(4)
% sigma(S,'b',Khinf*S,'r',T,'g',gopt/WP,'b-.',gopt/WU,'m-.',gopt/WT,'g-.',{1e-3,1e3})
% legend('S','KS','T','GAM/W1','GAM/W2','GAM/W3','Location','SouthWest');
...
% destabunc indica esattamente l'incertezza massima tollerabile dal sistema 
% oltre la quale non è robustamente stabile
